  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <h1 className="text-2xl sm:text-3xl font-bold neon-text-gold">Usuarios</h1>
        <button onClick={() => setShowModal(true)} className="btn-neon-cyan w-full sm:w-auto">+ Nuevo Usuario</button>
      </div>
